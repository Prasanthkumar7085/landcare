...
import { Card, CardContent, CardActions, IconButton, Typography, TextField, InputAdornment } from '@mui/material';
            ...
            <div className={styles.markersection}>
                <div className={styles.mapdetails}>
                    <div className={styles.markertop}>
                        <Typography variant="h6" className={styles.title}>Markers</Typography>
                        <div className={styles.inputsearch}>
                            ...
                            <div className={styles.inputfilter}>
                                <img className={styles.filtericon} alt="" src="/filtericon.svg" />
                            ...
                            <CardContent className={styles.locationcard}>
                                <div className={styles.locationprofile}>
                                    <div className={styles.locationname}>
                                        ...
                                        <Typography variant="subtitle1" className={styles.locationtitle}>{marker.title}</Typography>
                                    </div>
                                    <div className={styles.markerlocation1}>
                                        <LocationOnIcon className={styles.clock1Icon} />
                                        <Typography className={styles.filter}>{marker.type}</Typography>
                                    </div>
                                </div>
                                <Typography className={styles.paragraph1}>{marker.description}</Typography>
                                <div className={styles.longitudegroup}>
                                    <div className={styles.longitudediv}>
                                        <LocationOnIcon className={styles.clock1Icon} />
                                        <Typography className={styles.filter}>{marker.coordinates.join(", ")}</Typography>
                                    </div>
                                    <div className={styles.datetime1}>
                                        <AccessTimeIcon className={styles.timeicon} />
                                        <Typography className={styles.filter}>{datePipe(marker.created_at)}</Typography>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
